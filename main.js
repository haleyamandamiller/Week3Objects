...
var me = { name: "Haley",
          city: "Denver",
          jobTitle: "Designer",
          family: ["Jan", "Bill", "Maddie"]
};

document.getElementById("q1").innerHTML = me.name;
...
var jsWorkshop = { classmates: ["Allison", "James", "Lee", "Jim", "Ryan"]
...
document.getElementById("q12").innerHTML = jsWorkshop.Jim.length;
